export default function Provides() {
  return (
    <section id="provides" className="pb-40 1xl:pb-55 3xl:pb-60 4xl:pb-70">
      <div className="section flex flex-col 1xl:flex-row">
        <h2 className="font-second text-mercury-white tracking-[-0.02em] font-medium mb-9.5 leading-[110%] 1xl:mr-4 1xl:mb-0 3xl:mr-15 4xl:mr-22">
          Що надає HUB?
        </h2>
        <div>
